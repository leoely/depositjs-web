...
import HighLight from '~/script/class/HighLight';
import JavascriptLexer from '~/script/class/lexer/JavascriptLexer';
import javascriptTemplate from '~/script/lib/template/javascriptTemplate';
