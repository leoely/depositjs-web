    ...
    return (
      <>
        <div className={style.passage}>
          Depositis database cache library.Why need do this?Database store
          data in the disk.Read and write speed is lower than memory.Deposit.js
          use memory cache data which user already use.When need same data in
          the next time.Deposit.js will get it from memory with very high speed.
          Overall,use records.js can improve read and write speed of database.
        </div>
        <div className={style.passage}>
          Deposit.js use encapsulation api replace traditional sql sentences.
        ...
        <div className={style.passage}>
          ...
          mentioned step will cause communication cost.Deposit.js cross calculate
          reduce sql sentences use.In this way will reeduce progress
          communication as possible.
        </div>
        <div className={style.passage}>
          Deposit.js manage database use meticulously and have complex mechanism.
        ...
        <div className={style.passage}>
          ...
          store space than disk.Deposit.js will help user use small memory try
        ...
        <div className={style.passage}>
          ...
          by step.In this time,memory will out of limit.Deposit.js provider
