...
class Router extends WebApp {
  ...
  bindEvent() {
    ...
    emitter.on('page/introduce', async () => {
      const Introduce = await import('~/client/script/page/Introduce');
      this.addRoute('/introduce', Introduce.default);
      location.to('/introduce');
    });
  }
